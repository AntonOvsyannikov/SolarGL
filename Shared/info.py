...
def parse_docstring(docstring):
    ...
    return {
        u"short_description": unicode(short_description, 'utf-8'),
        u"long_description": unicode(long_description, 'utf-8'),
        u"params": [
            {
                u'name':unicode(p['name'], 'utf-8'),
                u'doc':unicode(p['doc'], 'utf-8')
            }
            for p in params
        ],
        u"returns": unicode(returns, 'utf-8')
    }
